...
reports$icpc2 <- list()
reports$icpc2$selected <- c("a04", "p20", "p81", "p29", "respiratory_infections", "covid19", "r80", "r71", "r81", "r72", "gastroenteritis")
...
#' @export
fida_pilot <- list()
fida_pilot$icpc2 <- icpc2[icpc2group_tag %in% c("a04", "r71", "r72", "r80", "r81", "covid19", "respiratory_infections", "gastroenteritis")]
