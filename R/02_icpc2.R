...
icpc2 <- rbindlist(list(
  ...
  data.table("B70", "b70", "Lymphadenitis acute", "Infections", "Blood, blood forming organs, and immune mechanism", "Lymfadenitt akutt", "Infeksjoner", "Blod, bloddannende organer og immunsystemet", "Infeksjonar", "Blod, bloddannande organ og immunsystemet"),
