...
<!--html_preserve--><div id="pyqpharxdl" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#pyqpharxdl .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#pyqpharxdl .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#pyqpharxdl .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#pyqpharxdl .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#pyqpharxdl .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#pyqpharxdl .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#pyqpharxdl .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#pyqpharxdl .gt_from_md > :first-child {
  margin-top: 0;
}

#pyqpharxdl .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#pyqpharxdl .gt_row_group_first td {
  border-top-width: 2px;
}

#pyqpharxdl .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#pyqpharxdl .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#pyqpharxdl .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#pyqpharxdl .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#pyqpharxdl .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#pyqpharxdl .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#pyqpharxdl .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#pyqpharxdl .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#pyqpharxdl .gt_font_normal {
  font-weight: normal;
}

#pyqpharxdl .gt_font_bold {
  font-weight: bold;
}

#pyqpharxdl .gt_font_italic {
  font-style: italic;
}
...
#pyqpharxdl .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#pyqpharxdl .gt_indent_1 {
  text-indent: 5px;
}

#pyqpharxdl .gt_indent_2 {
  text-indent: 10px;
}

#pyqpharxdl .gt_indent_3 {
  text-indent: 15px;
}

#pyqpharxdl .gt_indent_4 {
  text-indent: 20px;
}

#pyqpharxdl .gt_indent_5 {
  text-indent: 25px;
}
</style>
<table class="gt_table">
  <thead class="gt_header">
    <tr>
      <td colspan="7" class="gt_heading gt_title gt_font_normal" style>Registration delay (days) in NorSySS by isoyear</td>
    </tr>
    <tr>
...
<td headers="stub_1_17 95%" class="gt_row gt_right">37</td>
<td headers="stub_1_17 99%" class="gt_row gt_right">91</td></tr>
    <tr><th id="stub_1_18" scope="row" class="gt_row gt_right gt_stub">2023</th>
<td headers="stub_1_18 25%" class="gt_row gt_right">3</td>
<td headers="stub_1_18 50%" class="gt_row gt_right">7</td>
<td headers="stub_1_18 75%" class="gt_row gt_right">13</td>
<td headers="stub_1_18 90%" class="gt_row gt_right">20</td>
<td headers="stub_1_18 95%" class="gt_row gt_right">27</td>
<td headers="stub_1_18 99%" class="gt_row gt_right">44</td></tr>
  </tbody>
