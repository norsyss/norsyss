...
<!--html_preserve--><div id="oyakbuzruf" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#oyakbuzruf .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#oyakbuzruf .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#oyakbuzruf .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#oyakbuzruf .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#oyakbuzruf .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#oyakbuzruf .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#oyakbuzruf .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#oyakbuzruf .gt_from_md > :first-child {
  margin-top: 0;
}

#oyakbuzruf .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#oyakbuzruf .gt_row_group_first td {
  border-top-width: 2px;
}

#oyakbuzruf .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#oyakbuzruf .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#oyakbuzruf .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#oyakbuzruf .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#oyakbuzruf .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#oyakbuzruf .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#oyakbuzruf .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#oyakbuzruf .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#oyakbuzruf .gt_font_normal {
  font-weight: normal;
}

#oyakbuzruf .gt_font_bold {
  font-weight: bold;
}

#oyakbuzruf .gt_font_italic {
  font-style: italic;
}
...
#oyakbuzruf .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#oyakbuzruf .gt_indent_1 {
  text-indent: 5px;
}

#oyakbuzruf .gt_indent_2 {
  text-indent: 10px;
}

#oyakbuzruf .gt_indent_3 {
  text-indent: 15px;
}

#oyakbuzruf .gt_indent_4 {
  text-indent: 20px;
}

#oyakbuzruf .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
<td headers="stub_1_17 99%" class="gt_row gt_right">93</td></tr>
...
<td headers="stub_1_18 95%" class="gt_row gt_right">29</td>
<td headers="stub_1_18 99%" class="gt_row gt_right">49</td></tr>
  </tbody>
