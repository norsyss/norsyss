...
As of 2023-03-30, NorSySS holds 414 716 940 consultations with general practitioners and out-of-hours primary care facilities between 2006-01-02 and 2023-03-29.

<!--html_preserve--><div id="dbxfatgadn" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#dbxfatgadn .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#dbxfatgadn .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#dbxfatgadn .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#dbxfatgadn .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#dbxfatgadn .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#dbxfatgadn .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#dbxfatgadn .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#dbxfatgadn .gt_from_md > :first-child {
  margin-top: 0;
}

#dbxfatgadn .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#dbxfatgadn .gt_row_group_first td {
  border-top-width: 2px;
}

#dbxfatgadn .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#dbxfatgadn .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#dbxfatgadn .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#dbxfatgadn .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#dbxfatgadn .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#dbxfatgadn .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#dbxfatgadn .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#dbxfatgadn .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#dbxfatgadn .gt_font_normal {
  font-weight: normal;
}

#dbxfatgadn .gt_font_bold {
  font-weight: bold;
}

#dbxfatgadn .gt_font_italic {
  font-style: italic;
}
...
#dbxfatgadn .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#dbxfatgadn .gt_indent_1 {
  text-indent: 5px;
}

#dbxfatgadn .gt_indent_2 {
  text-indent: 10px;
}

#dbxfatgadn .gt_indent_3 {
  text-indent: 15px;
}

#dbxfatgadn .gt_indent_4 {
  text-indent: 20px;
}

#dbxfatgadn .gt_indent_5 {
  text-indent: 25px;
}
</style>
<table class="gt_table">
  <thead class="gt_header">
    ...
    <tr>
      <td colspan="4" class="gt_heading gt_subtitle gt_font_normal gt_bottom_border" style>2006-01-20 to 2023-03-29</td>
    </tr>
  </thead>
...
<td headers="consultations_n" class="gt_row gt_center">27 066 293</td></tr>
...
<td headers="consultations_n" class="gt_row gt_center">28 880 949</td></tr>
...
<td headers="consultations_n" class="gt_row gt_center">27 059 377</td></tr>
    <tr><td headers="isoyear" class="gt_row gt_center">2023</td>
<td headers="date_min" class="gt_row gt_center">2023-01-02</td>
<td headers="date_max" class="gt_row gt_center">2023-03-29</td>
<td headers="consultations_n" class="gt_row gt_center">5 966 009</td></tr>
  </tbody>
